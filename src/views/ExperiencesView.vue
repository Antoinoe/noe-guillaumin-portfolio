...
<template>
    ...
    <div id="page_content">
        ...
        <p class="expe_content">I had the incredible opportunity to work at INRIA. Collaborating with Gauthier Gendreau
            during this internship, we developed a Unity AR/VR application aimed at studying and comparing human
            feedback when interacting with a pseudo-haptic interface in both VR and AR environments.</p>
        <p class="expe_content">In virtual reality applications, immersion holds significant importance. The challenge
            of replicating the sensation of touching unreal objects has spurred extensive research for improvement. One
            prevalent method for achieving a sense of touch is through the use of vibration effects. Our objective was
        ...
        <p class="expe_content">Farm3 is a French startup specializing in the creation of an optimized structure for
            vertical farming. The "Cube," with its 12m² floor size, houses shelves containing plants in a closed
            environment that provides the right amount of nutrition to the plants inside. My objective was to develop an
